...
Using SSH-key:
  > git clone git@github.com:romans-adi/AwesomeBooks.git

Using HTTPS:
  > git clone https://github.com/romans-adi/AwesomeBooks.git

You can also create the new directory just adding the name of it in the end of command. For example:
  > git clone https://github.com/romans-adi/AwesomeBooks.git awesomeBooks
...
- **Add styles**
- **Add more properties/additional information to the Book objects**
